...
package net.greywind.compressedgrass.network;
...
import net.greywind.compressedgrass.world.inventory.GrassFurnaceGuiMenu;
import net.greywind.compressedgrass.procedures.GrassFurnaceGuiOpenPeriodProcedure;
...
public class GrassFurnaceGuiSlotMessage {
	...
	public static void handler(GrassFurnaceGuiSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
