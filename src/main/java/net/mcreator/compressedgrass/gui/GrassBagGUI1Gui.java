...
import net.mcreator.compressedgrass.procedures.GrassBagGUI1To2Procedure;
...
public class GrassBagGUI1Gui extends CompressedGrassModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public GrassBagGUI1Gui(CompressedGrassModElements instance) {
		super(instance, 165);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("grass_bag_gui_1"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, GrassBagGUI1GuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			GrassBagGUI1To2Procedure.executeProcedure(Stream
