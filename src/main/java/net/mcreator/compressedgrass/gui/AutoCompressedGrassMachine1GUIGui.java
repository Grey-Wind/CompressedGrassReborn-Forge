...
public class AutoCompressedGrassMachine1GUIGui extends CompressedGrassModElements.ModElement {
	...
	public AutoCompressedGrassMachine1GUIGui(CompressedGrassModElements instance) {
		super(instance, 356);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("auto_compressed_grass_machine_1_gui"));
		}
	}
