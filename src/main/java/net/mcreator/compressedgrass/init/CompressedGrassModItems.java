...
public class CompressedGrassModItems {
	...
	public static final RegistryObject<Item> COMPRESSED_GRASS = REGISTRY.register("compressed_grass",
	...
	public static final RegistryObject<Item> QUADRUPLE_COMPRESSED_GRASS = REGISTRY.register(
			"quadruple_compressed_grass",
			() -> new QuadrupleCompressedGrassItem());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS = REGISTRY.register(
			"quintuple_compressed_grass",
	...
	public static final RegistryObject<Item> GRASS_STRING = REGISTRY.register("grass_string",
			() -> new GrassStringItem());
	...
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_STRING = REGISTRY.register(
			"double_compressed_grass_string",
			() -> new DoubleCompressedGrassStringItem());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_STRING = REGISTRY.register(
			"triple_compressed_grass_string",
			() -> new TripleCompressedGrassStringItem());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_STRING = REGISTRY.register(
			"quintuple_compressed_grass_string",
			() -> new QuintupleCompressedGrassStringItem());
	public static final RegistryObject<Item> QUADRUPLE_COMPRESSED_GRASS_STRING = REGISTRY.register(
			"quadruple_compressed_grass_string",
			() -> new QuadrupleCompressedGrassStringItem());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_STRING = REGISTRY.register(
			"sextuple_compressed_grass_string",
			() -> new SextupleCompressedGrassStringItem());
	public static final RegistryObject<Item> SEPTUPLE_COMPRESSED_GRASS_STRING = REGISTRY.register(
			"septuple_compressed_grass_string",
			() -> new SeptupleCompressedGrassStringItem());
	public static final RegistryObject<Item> OCTUPLE_COMPRESSED_GRASS_STRING = REGISTRY.register(
			"octuple_compressed_grass_string",
			() -> new OctupleCompressedGrassStringItem());
	public static final RegistryObject<Item> NONUPLE_COMPRESSED_GRASS_STRING = REGISTRY.register(
			"nonuple_compressed_grass_string",
			() -> new NonupleCompressedGrassStringItem());
	public static final RegistryObject<Item> WINDING_GRASS_STICKS = REGISTRY.register("winding_grass_sticks",
			() -> new WindingGrassSticksItem());
	public static final RegistryObject<Item> COMPRESSED_GRASS_MACHINE = block(
			CompressedGrassModBlocks.COMPRESSED_GRASS_MACHINE,
			CompressedGrassModTabs.TAB_GRASS);
	public static final RegistryObject<Item> COMPRESSED_GRASS_MACHINE_PLUS = block(
			CompressedGrassModBlocks.COMPRESSED_GRASS_MACHINE_PLUS,
			CompressedGrassModTabs.TAB_GRASS);
	public static final RegistryObject<Item> SPAWN_AUTHOR = REGISTRY.register("spawn_author",
			() -> new SpawnAuthorItem());
	...
	public static final RegistryObject<Item> BIG_GRASS_CHEST = block(CompressedGrassModBlocks.BIG_GRASS_CHEST,
			CompressedGrassModTabs.TAB_STORAGE);
	...
	public static final RegistryObject<Item> BIG_GRASS_BAG = REGISTRY.register("big_grass_bag",
			() -> new BigGrassBagItem());
	public static final RegistryObject<Item> BIG_GRASS_BAG_PLUS = REGISTRY.register("big_grass_bag_plus",
			() -> new BigGrassBagPlusItem());
	...
	public static final RegistryObject<Item> GRASS_WOOD_FENCE = block(CompressedGrassModBlocks.GRASS_WOOD_FENCE,
			CompressedGrassModTabs.TAB_GRASS_WOOD);
	public static final RegistryObject<Item> GRASS_WOOD_FENCE_GATE = block(
			CompressedGrassModBlocks.GRASS_WOOD_FENCE_GATE,
			CompressedGrassModTabs.TAB_GRASS_WOOD);
	public static final RegistryObject<Item> GRASS_WOOD_PRESSURE_PLATE = block(
			CompressedGrassModBlocks.GRASS_WOOD_PRESSURE_PLATE,
			CompressedGrassModTabs.TAB_GRASS_WOOD);
	public static final RegistryObject<Item> COMPRESSED_GRASS_ARMOR_ARMOR_HELMET = REGISTRY.register(
			"compressed_grass_armor_armor_helmet",
			() -> new CompressedGrassArmorArmorItem.Helmet());
	public static final RegistryObject<Item> COMPRESSED_GRASS_ARMOR_ARMOR_CHESTPLATE = REGISTRY.register(
			"compressed_grass_armor_armor_chestplate",
			() -> new CompressedGrassArmorArmorItem.Chestplate());
	public static final RegistryObject<Item> COMPRESSED_GRASS_ARMOR_ARMOR_LEGGINGS = REGISTRY.register(
			"compressed_grass_armor_armor_leggings",
			() -> new CompressedGrassArmorArmorItem.Leggings());
	public static final RegistryObject<Item> COMPRESSED_GRASS_ARMOR_ARMOR_BOOTS = REGISTRY.register(
			"compressed_grass_armor_armor_boots",
	...
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_ARMOR_ARMOR_HELMET = REGISTRY
			.register("double_compressed_grass_armor_armor_helmet",
					() -> new DoubleCompressedGrassArmorArmorItem.Helmet());
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_ARMOR_ARMOR_CHESTPLATE = REGISTRY
			.register("double_compressed_grass_armor_armor_chestplate",
					() -> new DoubleCompressedGrassArmorArmorItem.Chestplate());
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_ARMOR_ARMOR_LEGGINGS = REGISTRY
			.register("double_compressed_grass_armor_armor_leggings",
					() -> new DoubleCompressedGrassArmorArmorItem.Leggings());
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_ARMOR_ARMOR_BOOTS = REGISTRY
			.register("double_compressed_grass_armor_armor_boots",
					() -> new DoubleCompressedGrassArmorArmorItem.Boots());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_ARMOR_ARMOR_HELMET = REGISTRY
			.register("triple_compressed_grass_armor_armor_helmet",
					() -> new TripleCompressedGrassArmorArmorItem.Helmet());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_ARMOR_ARMOR_CHESTPLATE = REGISTRY
			.register("triple_compressed_grass_armor_armor_chestplate",
					() -> new TripleCompressedGrassArmorArmorItem.Chestplate());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_ARMOR_ARMOR_LEGGINGS = REGISTRY
			.register("triple_compressed_grass_armor_armor_leggings",
					() -> new TripleCompressedGrassArmorArmorItem.Leggings());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_ARMOR_ARMOR_BOOTS = REGISTRY
			.register("triple_compressed_grass_armor_armor_boots",
					() -> new TripleCompressedGrassArmorArmorItem.Boots());
	...
	public static final RegistryObject<Item> QUADRUPLE_ARMOR_CHESTPLATE = REGISTRY.register(
			"quadruple_armor_chestplate",
	...
	public static final RegistryObject<Item> QUADRUPLE_ARMOR_BOOTS = REGISTRY.register("quadruple_armor_boots",
			() -> new QuadrupleArmorItem.Boots());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_ARMOR_ARMOR_HELMET = REGISTRY
			.register("quintuple_compressed_grass_armor_armor_helmet",
					() -> new QuintupleCompressedGrassArmorArmorItem.Helmet());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_ARMOR_ARMOR_CHESTPLATE = REGISTRY
			.register("quintuple_compressed_grass_armor_armor_chestplate",
					() -> new QuintupleCompressedGrassArmorArmorItem.Chestplate());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_ARMOR_ARMOR_LEGGINGS = REGISTRY
			.register("quintuple_compressed_grass_armor_armor_leggings",
					() -> new QuintupleCompressedGrassArmorArmorItem.Leggings());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_ARMOR_ARMOR_BOOTS = REGISTRY
			.register("quintuple_compressed_grass_armor_armor_boots",
					() -> new QuintupleCompressedGrassArmorArmorItem.Boots());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_ARMOR_ARMOR_HELMET = REGISTRY
			.register("sextuple_compressed_grass_armor_armor_helmet",
					() -> new SextupleCompressedGrassArmorArmorItem.Helmet());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_ARMOR_ARMOR_CHESTPLATE = REGISTRY
			.register("sextuple_compressed_grass_armor_armor_chestplate",
					() -> new SextupleCompressedGrassArmorArmorItem.Chestplate());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_ARMOR_ARMOR_LEGGINGS = REGISTRY
			.register("sextuple_compressed_grass_armor_armor_leggings",
					() -> new SextupleCompressedGrassArmorArmorItem.Leggings());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_ARMOR_ARMOR_BOOTS = REGISTRY
			.register("sextuple_compressed_grass_armor_armor_boots",
					() -> new SextupleCompressedGrassArmorArmorItem.Boots());
	public static final RegistryObject<Item> SEPTUPLE_ARMOR_HELMET = REGISTRY.register("septuple_armor_helmet",
			() -> new SeptupleArmorItem.Helmet());
	...
	public static final RegistryObject<Item> SEPTUPLE_ARMOR_BOOTS = REGISTRY.register("septuple_armor_boots",
			() -> new SeptupleArmorItem.Boots());
	public static final RegistryObject<Item> OCTUPLE_ARMOR_HELMET = REGISTRY.register("octuple_armor_helmet",
			() -> new OctupleArmorItem.Helmet());
	...
	public static final RegistryObject<Item> OCTUPLE_ARMOR_BOOTS = REGISTRY.register("octuple_armor_boots",
			() -> new OctupleArmorItem.Boots());
	public static final RegistryObject<Item> NONUPLE_GRASS_ARMOR_HELMET = REGISTRY.register(
			"nonuple_grass_armor_helmet",
			() -> new NonupleGrassArmorItem.Helmet());
	public static final RegistryObject<Item> NONUPLE_GRASS_ARMOR_CHESTPLATE = REGISTRY.register(
			"nonuple_grass_armor_chestplate",
			() -> new NonupleGrassArmorItem.Chestplate());
	public static final RegistryObject<Item> NONUPLE_GRASS_ARMOR_LEGGINGS = REGISTRY.register(
			"nonuple_grass_armor_leggings",
	...
	public static final RegistryObject<Item> COMPRESSED_HOE = REGISTRY.register("compressed_hoe",
			() -> new CompressedHoeItem());
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_TOOLS_PICKAXE = REGISTRY.register(
			"double_compressed_grass_tools_pickaxe",
			() -> new DoubleCompressedGrassToolsPickaxeItem());
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_TOOLS_AXE = REGISTRY.register(
			"double_compressed_grass_tools_axe",
			() -> new DoubleCompressedGrassToolsAxeItem());
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_TOOLS_SHOVEL = REGISTRY.register(
			"double_compressed_grass_tools_shovel",
			() -> new DoubleCompressedGrassToolsShovelItem());
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_TOOLS_HOE = REGISTRY.register(
			"double_compressed_grass_tools_hoe",
			() -> new DoubleCompressedGrassToolsHoeItem());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_TOOLS_PICKAXE = REGISTRY.register(
			"triple_compressed_grass_tools_pickaxe",
			() -> new TripleCompressedGrassToolsPickaxeItem());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_TOOLS_AXE = REGISTRY.register(
			"triple_compressed_grass_tools_axe",
			() -> new TripleCompressedGrassToolsAxeItem());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_TOOLS_SHOVEL = REGISTRY.register(
			"triple_compressed_grass_tools_shovel",
			() -> new TripleCompressedGrassToolsShovelItem());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_TOOLS_HOE = REGISTRY.register(
			"triple_compressed_grass_tools_hoe",
			() -> new TripleCompressedGrassToolsHoeItem());
	public static final RegistryObject<Item> QUADRUPLE_COMPRESSED_GRASS_TOOLS_PICKAXE = REGISTRY.register(
			"quadruple_compressed_grass_tools_pickaxe",
			() -> new QuadrupleCompressedGrassToolsPickaxeItem());
	public static final RegistryObject<Item> QUADRUPLE_COMPRESSED_GRASS_TOOLS_AXE = REGISTRY.register(
			"quadruple_compressed_grass_tools_axe",
			() -> new QuadrupleCompressedGrassToolsAxeItem());
	public static final RegistryObject<Item> QUADRUPLE_COMPRESSED_GRASS_TOOLS_SHOVEL = REGISTRY.register(
			"quadruple_compressed_grass_tools_shovel",
			() -> new QuadrupleCompressedGrassToolsShovelItem());
	public static final RegistryObject<Item> QUADRUPLE_COMPRESSED_GRASS_TOOLS_HOE = REGISTRY.register(
			"quadruple_compressed_grass_tools_hoe",
			() -> new QuadrupleCompressedGrassToolsHoeItem());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_TOOLS_PICKAXE = REGISTRY.register(
			"quintuple_compressed_grass_tools_pickaxe",
			() -> new QuintupleCompressedGrassToolsPickaxeItem());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_TOOLS_AXE = REGISTRY.register(
			"quintuple_compressed_grass_tools_axe",
			() -> new QuintupleCompressedGrassToolsAxeItem());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_TOOLS_SHOVEL = REGISTRY.register(
			"quintuple_compressed_grass_tools_shovel",
			() -> new QuintupleCompressedGrassToolsShovelItem());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_TOOLS_HOE = REGISTRY.register(
			"quintuple_compressed_grass_tools_hoe",
			() -> new QuintupleCompressedGrassToolsHoeItem());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_TOOLS_PICKAXE = REGISTRY.register(
			"sextuple_compressed_grass_tools_pickaxe",
			() -> new SextupleCompressedGrassToolsPickaxeItem());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_TOOLS_AXE = REGISTRY.register(
			"sextuple_compressed_grass_tools_axe",
			() -> new SextupleCompressedGrassToolsAxeItem());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_TOOLS_SHOVEL = REGISTRY.register(
			"sextuple_compressed_grass_tools_shovel",
			() -> new SextupleCompressedGrassToolsShovelItem());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_TOOLS_HOE = REGISTRY.register(
			"sextuple_compressed_grass_tools_hoe",
			() -> new SextupleCompressedGrassToolsHoeItem());
	public static final RegistryObject<Item> SEPTUPLE_COMPRESSED_GRASS_TOOLS_PICKAXE = REGISTRY.register(
			"septuple_compressed_grass_tools_pickaxe",
			() -> new SeptupleCompressedGrassToolsPickaxeItem());
	public static final RegistryObject<Item> SEPTUPLE_COMPRESSED_GRASS_TOOLS_AXE = REGISTRY.register(
			"septuple_compressed_grass_tools_axe",
			() -> new SeptupleCompressedGrassToolsAxeItem());
	public static final RegistryObject<Item> SEPTUPLE_COMPRESSED_GRASS_TOOLS_SHOVEL = REGISTRY.register(
			"septuple_compressed_grass_tools_shovel",
			() -> new SeptupleCompressedGrassToolsShovelItem());
	public static final RegistryObject<Item> SEPTUPLE_COMPRESSED_GRASS_TOOLS_HOE = REGISTRY.register(
			"septuple_compressed_grass_tools_hoe",
			() -> new SeptupleCompressedGrassToolsHoeItem());
	public static final RegistryObject<Item> GRASS_DIMENSION = REGISTRY.register("grass_dimension",
			() -> new GrassDimensionItem());
	public static final RegistryObject<Item> OCTUPLE_GRASS_PICKAXE = REGISTRY.register("octuple_grass_pickaxe",
			() -> new OctupleGrassPickaxeItem());
	public static final RegistryObject<Item> OCTUPLE_GRASS_AXE = REGISTRY.register("octuple_grass_axe",
			() -> new OctupleGrassAxeItem());
	public static final RegistryObject<Item> OCTUPLE_GRASS_SHOVEL = REGISTRY.register("octuple_grass_shovel",
			() -> new OctupleGrassShovelItem());
	public static final RegistryObject<Item> OCTUPLE_GRASS_HOE = REGISTRY.register("octuple_grass_hoe",
			() -> new OctupleGrassHoeItem());
	public static final RegistryObject<Item> NONUPLE_GRASS_PICKAXE = REGISTRY.register("nonuple_grass_pickaxe",
			() -> new NonupleGrassPickaxeItem());
	public static final RegistryObject<Item> NONUPLE_GRASS_AXE = REGISTRY.register("nonuple_grass_axe",
			() -> new NonupleGrassAxeItem());
	public static final RegistryObject<Item> NONUPLE_GRASS_SHOVEL = REGISTRY.register("nonuple_grass_shovel",
			() -> new NonupleGrassShovelItem());
	public static final RegistryObject<Item> NONUPLE_GRASS_HOE = REGISTRY.register("nonuple_grass_hoe",
			() -> new NonupleGrassHoeItem());
	public static final RegistryObject<Item> DOUBLE_COMPRESSED_GRASS_TOOLS_SWORD = REGISTRY.register(
			"double_compressed_grass_tools_sword",
			() -> new DoubleCompressedGrassToolsSwordItem());
	public static final RegistryObject<Item> TRIPLE_COMPRESSED_GRASS_TOOLS_SWORD = REGISTRY.register(
			"triple_compressed_grass_tools_sword",
			() -> new TripleCompressedGrassToolsSwordItem());
	public static final RegistryObject<Item> QUADRUPLE_COMPRESSED_GRASS_TOOLS_SWORD = REGISTRY.register(
			"quadruple_compressed_grass_tools_sword",
			() -> new QuadrupleCompressedGrassToolsSwordItem());
	public static final RegistryObject<Item> QUINTUPLE_COMPRESSED_GRASS_TOOLS_SWORD = REGISTRY.register(
			"quintuple_compressed_grass_tools_sword",
			() -> new QuintupleCompressedGrassToolsSwordItem());
	public static final RegistryObject<Item> SEXTUPLE_COMPRESSED_GRASS_TOOLS_SWORD = REGISTRY.register(
			"sextuple_compressed_grass_tools_sword",
			() -> new SextupleCompressedGrassToolsSwordItem());
	public static final RegistryObject<Item> SEPTUPLE_COMPRESSED_GRASS_TOOLS_SWORD = REGISTRY.register(
			"septuple_compressed_grass_tools_sword",
			() -> new SeptupleCompressedGrassToolsSwordItem());
	public static final RegistryObject<Item> OCTUPLE_GRASS_SWORD = REGISTRY.register("octuple_grass_sword",
			() -> new OctupleGrassSwordItem());
	public static final RegistryObject<Item> NONUPLE_GRASS_SWORD = REGISTRY.register("nonuple_grass_sword",
			() -> new NonupleGrassSwordItem());
	public static final RegistryObject<Item> GRASS_ORE = block(CompressedGrassModBlocks.GRASS_ORE,
			CompressedGrassModTabs.TAB_GRASS_ORE_TAB);
	public static final RegistryObject<Item> BROKEN_GRASS_NUGGET = REGISTRY.register("broken_grass_nugget",
			() -> new BrokenGrassNuggetItem());
	public static final RegistryObject<Item> GRASS_NUGGET = REGISTRY.register("grass_nugget",
			() -> new GrassNuggetItem());
	public static final RegistryObject<Item> GRASS_INGOT = REGISTRY.register("grass_ingot", () -> new GrassIngotItem());
	public static final RegistryObject<Item> GRASS_BLOCK = block(CompressedGrassModBlocks.GRASS_BLOCK,
			CompressedGrassModTabs.TAB_GRASS_ORE_TAB);
	...
	public static final RegistryObject<Item> INCREASE_CAPACITY = REGISTRY.register("increase_capacity",
			() -> new IncreaseCapacityItem());
	...
	public static final RegistryObject<Item> ENCHANTED_GRASS = REGISTRY.register("enchanted_grass",
			() -> new EnchantedGrassItem());
	public static final RegistryObject<Item> LIMIT_ARMOR_HELMET = REGISTRY.register("limit_armor_helmet",
			() -> new LimitArmorItem.Helmet());
	...
	public static final RegistryObject<Item> LIMIT_ARMOR_LEGGINGS = REGISTRY.register("limit_armor_leggings",
			() -> new LimitArmorItem.Leggings());
	public static final RegistryObject<Item> LIMIT_ARMOR_BOOTS = REGISTRY.register("limit_armor_boots",
			() -> new LimitArmorItem.Boots());
	...
	public static final RegistryObject<Item> ENCHANTED_ARMOR_CHESTPLATE = REGISTRY.register(
			"enchanted_armor_chestplate",
	...
	public static final RegistryObject<Item> ENCHANTED_ARMOR_BOOTS = REGISTRY.register("enchanted_armor_boots",
			() -> new EnchantedArmorItem.Boots());
	public static final RegistryObject<Item> LIMIT_PICKAXE = REGISTRY.register("limit_pickaxe",
			() -> new LimitPickaxeItem());
	...
	public static final RegistryObject<Item> LIMIT_SHOVEL = REGISTRY.register("limit_shovel",
			() -> new LimitShovelItem());
	...
	public static final RegistryObject<Item> CHRISTMAS_TREE = block(CompressedGrassModBlocks.CHRISTMAS_TREE,
