...
public class GrassWoodLeavesBlock extends CompressedGrassModElements.ModElement {
	@ObjectHolder("compressed_grass:grass_wood_leaves")
	public static final Block block = null;

	public GrassWoodLeavesBlock(CompressedGrassModElements instance) {
		super(instance, 102);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.24f, 0.24f).setLightLevel(s -> 0)
					.notSolid());
			setRegistryName("grass_wood_leaves");
		}
