...
import net.mcreator.compressedgrass.procedures.CompressedGrassMachinePlusRedstonUpProcedure;
...
public class CompressedGrassMachinePlusBlock extends CompressedGrassModElements.ModElement {
	@ObjectHolder("compressed_grass:compressed_grass_machine_plus")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compressed_grass_machine_plus");
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				CompressedGrassMachinePlusRedstonUpProcedure.executeProcedure(Stream
