...
public class GrassWoodButtonBlock extends CompressedGrassModElements.ModElement {
	@ObjectHolder("compressed_grass:grass_wood_button")
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.4f, 3.5999999999999996f)
					.setLightLevel(s -> 0));
			setRegistryName("grass_wood_button");
		}
