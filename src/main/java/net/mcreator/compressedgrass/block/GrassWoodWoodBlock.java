...
public class GrassWoodWoodBlock extends CompressedGrassModElements.ModElement {
	@ObjectHolder("compressed_grass:grass_wood_wood")
	public static final Block block = null;

	public GrassWoodWoodBlock(CompressedGrassModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.4f, 2.3140620096063054f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("grass_wood_wood");
		}
