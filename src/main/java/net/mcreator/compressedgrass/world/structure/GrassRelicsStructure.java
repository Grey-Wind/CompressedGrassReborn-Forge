...
package net.mcreator.compressedgrass.world.structure;
...
public class GrassRelicsStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("compressed_grass", "grass_relics"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("grass_relics"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("compressed_grass:grass_relics"), configuredFeature);
		}
	}
