...
import net.mcreator.compressedgrass.gui.BigGrassBagPlusGUIGuiWindow;
import net.mcreator.compressedgrass.gui.BigGrassBagPlusGUIGui;
...
public class BigGrassBagPlusItem extends CompressedGrassModElements.ModElement {
	@ObjectHolder("compressed_grass:big_grass_bag_plus")
	public static final Item block = null;

	public BigGrassBagPlusItem(CompressedGrassModElements instance) {
		super(instance, 313);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BigGrassBagPlusGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("big_grass_bag_plus");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BigGrassBagPlusGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
