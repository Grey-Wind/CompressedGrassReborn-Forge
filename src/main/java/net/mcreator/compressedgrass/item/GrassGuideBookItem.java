...
import net.mcreator.compressedgrass.gui.GrassGuideBookGUI1GuiWindow;
import net.mcreator.compressedgrass.gui.GrassGuideBookGUI1Gui;
...
public class GrassGuideBookItem extends CompressedGrassModElements.ModElement {
	@ObjectHolder("compressed_grass:grass_guide_book")
	public static final Item block = null;

	public GrassGuideBookItem(CompressedGrassModElements instance) {
		super(instance, 209);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof GrassGuideBookGUI1GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("grass_guide_book");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Grass Guide Book");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GrassGuideBookGUI1Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
