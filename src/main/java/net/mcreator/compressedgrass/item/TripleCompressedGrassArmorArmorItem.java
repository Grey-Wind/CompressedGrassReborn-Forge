...
public abstract class TripleCompressedGrassArmorArmorItem extends ArmorItem {
	public TripleCompressedGrassArmorArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends TripleCompressedGrassArmorArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "compressed_grass:textures/models/armor/triplecompressedgrassarmor_layer_1.png";
		}
	}

	public static class Chestplate extends TripleCompressedGrassArmorArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends TripleCompressedGrassArmorArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "compressed_grass:textures/models/armor/triplecompressedgrassarmor_layer_2.png";
		}
	}

	public static class Boots extends TripleCompressedGrassArmorArmorItem {
		public Boots() {
